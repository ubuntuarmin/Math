...
// --- 1.5 Helper: Send referral notification to inbox ---
async function sendReferralNotification(referrerUid, newUserEmail) {
  try {
    ...
    try {
      ...
      if (referralCode) {
        try {
          ...
          console.warn(
            "Referral system bypassed (Check Firestore index/rules):",
            refErr
          );
        }
      }
