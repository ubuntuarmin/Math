...
async function tryAwardReferralPlaytimeOffer(referredUid) {
  ...
  try {
    await addDoc(collection(db, "messages"), {
      ...
      text: `You passed ${REFERRAL_OFFER_THRESHOLD_MINUTES} playtime minutes this month. You and your referrer each got +${REFERRAL_OFFER_REWARD_MINUTES} free minutes.`,
      type: "referral",
      timestamp: serverTimestamp(),
      read: false,
    });
  ...
  try {
    await addDoc(collection(db, "messages"), {
      ...
      fromName: "Referral",
      title: "Referral Milestone Reward 🎁",
      text: `One of your referrals passed ${REFERRAL_OFFER_THRESHOLD_MINUTES} playtime minutes this month. You both got +${REFERRAL_OFFER_REWARD_MINUTES} free minutes.`,
      type: "referral",
      timestamp: serverTimestamp(),
      read: false,
    });
